...
# This only rewrites jamovi's compatibility metadata; it does not rebuild R
# code. Adapted from the sibling modules' tools/prepare-jmo.sh, generalized
# to read MODULE/VERSION from combo/DESCRIPTION.
#
